...
Open **Settings → Community plugins → Browse**, search for **AI API Key Checker**, and install — or open it directly in the [community plugin catalog](https://community.obsidian.md/plugins/api-key-checker). Then enable the plugin.
